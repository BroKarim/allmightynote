...
<ComponentPreview Component={EarthIconDemo} />
The OTPInput component from the OTP input library is a customizable One-time password input
component for React. It allows you to:
