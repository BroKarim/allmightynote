...
I got this code from [v1.run](https://github.com/midday-ai/v1/blob/main/apps/web/src/components/animated-text.tsx) you can checkout his (repo)[]. as you can see first we defin the Characters for Scrambling, hese characters will be used to generate the random characters that “scramble” the text.
